        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title col-10" style="width: 80%" id="exampleModalLabel">
                    <p id="titleclienteSesion" style="display: none;">Iniciar Sesion - Cliente</p>
                    <p id="titlecarpinteroSesion">Iniciar Sesion - Carpintero</p>
                </h3>
                        ...
                        function FuncionIniciarSesion() {
                            setTimeout(function ()
                            {
                                if ($('#opt_carpintero_iniciar').prop('checked')) {
                                    ...
                                    $('#titlecarpinteroSesion').show();
                                    $('#titleclienteSesion').hide();
                                } else if ($('#opt_cliente_iniciar').prop('checked')) {
                                    $('#forminiciarsesion').attr('action', 'ServletCliente');
                                    $('#titlecarpinteroSesion').hide();
                                    $('#titleclienteSesion').show();
                                }
                            }, 10);
                        }
                    </script>

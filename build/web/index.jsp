...
<html lang="en">
   ...
   <body class="building_version" data-spy="scroll" data-target=".header">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-hidden">
                        ...
                        <div class="top-area-block top-area-socials socials-colored-hover">
                           <div class="socials inline-inside"> 
                              <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" title="iniciar sección"><i class="fa fa-user" aria-hidden="true"></i></button>
                              <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModaal" title="registrase"><i class="fa fa-user-plus" aria-hidden="true"></i></button>
      ...
      <div id="home" class="parallax first-section" data-stellar-background-ratio="0.4" style="background-image:url('uploads/building/slide-img1.jpg');">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="widget widget_links">
                     ...
                     <ul class="wprt-links clearfix col2">
                        ...
                        <li><a data-scroll="" href="#about">Iniciar Cotizaci�n</a></li>
                        <li><a data-scroll="" href="#services">Propuestas</a></li>
                        <li><a data-scroll="" href="#projects">nuestros proyectos</a></li>
                        <li><a data-scroll="" href="#testimonials">comentarios</a></li>
...
<div class="modal fade" id="exampleModaal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Pagina de Registrase</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-warninging">Save changes</button>
      </div>
    </div>
  </div>
</div>
